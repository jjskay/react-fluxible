              ...
              <ul>
                {
                  data.map((v,i) => {
                     ...
                     return (
                         <li className={li} key={i} data-i={i} onMouseEnter={this.onMouseShowMenu}   onMouseLeave={this.onMouseHideMenu}>
